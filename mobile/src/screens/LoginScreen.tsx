    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={styles.headerArea}>
          <Text style={styles.title}>LIGA <Text style={styles.accentText}>CRAQUES</Text></Text>
          <Text style={styles.subtitle}>Enter your credentials to access the league</Text>
        </View>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#0F172A', // Sleek deep slate
  },
  scrollContainer: {
    flexGrow: 1,
  ...
  card: {
    backgroundColor: '#1E293B', // Glassmorphic card overlay
    borderRadius: 16,
    padding: 24,
    borderWidth: 1,
    borderColor: '#334155',
